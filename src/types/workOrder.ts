export type Screen = "orders" | "mode" | "select" | "prepare" | "confirm" | "running" | "records" | "local-orders" | "appointments" | "log-audit" | "vacant-room" | "vacant-room-fill" | "resident-security-prefill" | "daily-batch-prefill" | "all-work-orders" | "settings" | "backup-restore" | "visit-verify" | "image-encoding" | "signature" | "signature-management";

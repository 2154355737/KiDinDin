export type Screen = "orders" | "mode" | "select" | "prepare" | "confirm" | "running" | "records" | "local-orders" | "appointments" | "log-audit" | "vacant-room" | "vacant-room-fill" | "all-work-orders" | "settings";

...
export function AppDrawer({ type, order, detail, detailAjInfo, detailLoading, detailError, theme, auth, libraryPhotos, defaultOperatorName, setDefaultOperatorName, setTheme, onRetryLog, onRefreshSession, onSaveRefreshToken, onExportSession, onClose, onLogout }: {
  type: DrawerKind;
  order: WorkOrder;

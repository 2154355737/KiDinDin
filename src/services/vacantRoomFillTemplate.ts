export type VacantRoomFillTemplateLine = {
  attrCode: string;
  attrVal: unknown;
...
export const VACANT_ROOM_FILL_TEMPLATE = [
    {
        "attrCode":  "ZTCF0001",
        "attrVal":  "",
        "attrDetail":  {
    ...
    {
        "attrCode":  "isRecording",
        "attrVal":  "",
        "attrDetail":  {

                       }
    }
] satisfies VacantRoomFillTemplateLine[];

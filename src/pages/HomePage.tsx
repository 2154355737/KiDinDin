...
export function HomePage({ orders, query, date, localMetaById, prioritizePinned = true, onQueryChange, onDateChange, onOpenSettings, onFilter, onDetail }: { orders: WorkOrder[]; query: string; date: string; localMetaById: Record<string, LocalWorkOrderMeta>; prioritizePinned?: boolean; onQueryChange: (value: string) => void; onDateChange: (value: string) => void; onOpenSettings: () => void; onFilter: () => void; onDetail: (order: WorkOrder) => void }) {
